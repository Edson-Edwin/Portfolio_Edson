...
export default function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }: PixelCardProps) {
  ...
  useEffect(() => {
    initPixels();
    // Auto-trigger the animation on mount so it plays instantly without needing hover
    handleAnimation('appear');
  ...
  return (
    ...
    >
      <canvas className="pixel-canvas z-0" ref={canvasRef} />
