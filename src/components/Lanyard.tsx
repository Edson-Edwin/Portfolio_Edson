...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
  ...
  const cardTexture = useTexture('/card_combined.png');

  cardTexture.flipY = false; // Required to align texture with GLTF UV maps
  // Using the combined image that perfectly fits both front (left) and back (right).
